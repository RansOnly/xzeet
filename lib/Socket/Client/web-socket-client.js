...
// ambil opsi dari config (jika ada)
const wsOptions = {
  ...
  // baca maxPayload dari config.options.maxPayload atau fallback ke 1GB//
  maxPayload: (this.config?.options?.maxPayload) || (1024 * 1024 * 1024)
};

this.socket = new ws_1.default(this.url, wsOptions);
